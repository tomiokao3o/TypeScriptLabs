...
//Задание 1
    ...
    export class OwnerClass implements Owner {
        ...
        constructor(surname: string, name: string, lastName: string, birthday: string, typeOfDocument: TypeOfDocument, series: string, number: string) {
        ...
        printOwnerInfo(): void {
            ...
            console.log(`Дата рождения: ${this.getBirthday}`);
    ...
    let date1 = '03.06.2005';
    let owner1 = new OwnerClass("Дымченко", "Вячеслав", "Владимирович", date1, TypeOfDocument.passport, "1234", "567890");
